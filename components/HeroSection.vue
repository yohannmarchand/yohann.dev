...
<!--    <img class="" src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRGqU7gf8jJ5bWsbyg6UuKyr1-ZNW5KqP_3oA&usqp=CAU">-->
    ...
    <div class="inset-0 h-full flex flex-col space-y-8 items-center justify-center md:flex-row md:space-y-0 md:space-x-6">
      ...
      <div class="text-blue-600">
        ...
        <div class="mt-4 flex space-x-3">
          <a href="https://github.com/yohannmarchand" target="_blank" class="w-8 h-8 fill-blue-600">
          ...
          <a href="https://www.linkedin.com/in/yohann-marchand-5b8522175/" target="_blank"  class="w-8 h-8  fill-blue-600">
